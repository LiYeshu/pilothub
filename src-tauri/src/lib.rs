...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_product_feedback_status,
            commands::set_product_feedback_enabled,
            commands::clear_product_feedback,
            commands::record_product_feedback_event,
            ...
            commands::install_git_selection_with_apm,
            commands::inspect_codex_plugin,
