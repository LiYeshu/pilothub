export const resources = {
  en: {
    translation: {
      ...
      plugins: {
        add: 'Install Plugin',
        sectionTitle: 'Codex Plugins',
        sectionSubtitle:
          'Skill-only Plugins installed and managed as one capability.',
        pluginCount: '{{count}} Plugins',
        installTitle: 'Install Codex Plugin',
  ...
  zh: {
    translation: {
      ...
      plugins: {
        add: '安装 Plugin',
        sectionTitle: 'Codex Plugins',
        sectionSubtitle: '以完整能力为单位安装和管理的 Skill-only Plugins。',
        pluginCount: '{{count}} 个 Plugins',
        installTitle: '安装 Codex Plugin',
        gitSource: 'Git 仓库',
        localSource: '本地目录',
        repositoryUrl: '仓库地址',
