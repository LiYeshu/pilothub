export const resources = {
  en: {
    translation: {
      ...
      quickInstall: {
        action: 'Quick install',
        autoTargetsTitle: 'Automatic Agent setup',
        autoTargetsDescription: 'PilotHub will install globally and sync to {{targets}}.',
        noAgentsTitle: 'No supported AI Agent detected',
        noAgentsDescription:
          'Install or configure an Agent before adding your first capability.',
        manageAgents: 'Manage Agents',
        successTitle: 'Installation complete',
        successDescription: '{{name}} is ready to use.',
        installedTo: 'Installed to',
        nextStep: 'Next step',
        usageHint:
          'Open an installed Agent and describe what you want. It can now use {{name}}.',
        done: 'Done',
        viewSkill: 'View usage',
      },
      installDiagnostics: {
        action: 'Run diagnostics',
        title: 'Installation diagnostics',
        subtitle: 'Check the connection, Agent targets, directories, and Skill format.',
        running: 'Checking installation prerequisites…',
        runningHint: 'Repository validation can take a moment.',
        unavailable: 'Diagnostics could not be completed',
        retry: 'Run again',
        checks: {
          github: {
            title: 'GitHub connection',
            pass: 'GitHub is reachable.',
            warning: 'GitHub connectivity could not be confirmed.',
            fail: 'PilotHub cannot reach GitHub. {{detail}}',
            hint: 'Check your network and the GitHub proxy in Settings.',
          },
          agents: {
            title: 'AI Agent',
            pass: 'Detected: {{detail}}',
            warning: 'No selected Agent could be confirmed.',
            fail: 'No supported AI Agent was detected.',
            hint: 'Install an Agent or enable it in Tools.',
          },
          directories: {
            title: 'Agent directories',
            pass: '{{count}} target directories are writable.',
            warning: 'Directories will be checked after an Agent is detected.',
            fail: 'One or more target directories are not writable.',
            hint: 'Check directory permissions or choose another Agent target.',
          },
          skill_format: {
            title: 'Skill format',
            pass: 'Found a valid Skill definition.',
            warning: 'The Skill format could not be confirmed.',
            fail: 'No valid SKILL.md could be read. {{detail}}',
            hint: 'Use a Skill folder or repository containing a valid SKILL.md.',
          },
        },
      },
      storageMigration: {
      ...
      subtitle: 'Manage AI Agent Extensions',
      ...
      extensions: {
        ...
        noTargets: 'Not synced to an Agent',
        globalTargets: '{{count}} global',
        projectTargets: '{{count}} project',
      ...
      plugins: {
        add: 'Install AI Capability',
        sectionTitle: 'AI Expert Teams & Capabilities',
        sectionSubtitle:
          'Business capabilities packaged for Codex and managed as one unit.',
        pluginCount: '{{count}} installed',
        installTitle: 'Install AI Capability',
        expertTeam: 'AI Expert Team',
        aiCapability: 'AI Capability',
        expertTeamDetails: 'AI Expert Team',
        capabilityDetails: 'AI Capability',
        professionalCapabilities: 'Professional capabilities',
        professionalCapabilitiesHint:
          'Codex selects these Skills together when they fit the task.',
        capabilityHint: 'The Skill Codex can use for matching tasks.',
        specialistCount: '{{count}} specialists',
        capabilityCount: '{{count}} capability',
        ...
        gitPlaceholder: 'https://github.com/owner/plugin',
        localPlaceholder: '~/plugins/example-plugin',
        sourceHint:
          'The Plugin must include .codex-plugin/plugin.json and at least one valid Skill.',
        selectFolder: 'Select Plugin folder',
        preview: 'Preview',
        checking: 'Checking…',
        install: 'Install to Codex',
        ...
        runtimeStatusHint:
          'Installation, discovery, and real task execution are checked separately.',
        runtimeCodex: 'Codex',
        runtimeChat: 'Chat',
        runtimeWork: 'Work',
        runtimeCount: '{{count}} hosts',
        runtimeVerified: 'Execution verified',
        runtimeReady: 'Ready; test execution',
        runtimeUnverified: 'Not verified',
        runtimeDetailCodexReady:
          'Codex reports the Plugin as installed and enabled. Run a real task to verify execution.',
        runtimeDetailCodexUnavailable:
          'The Plugin is not installed and enabled in Codex.',
        runtimeDetailChat:
          'PilotHub cannot inspect whether the current Chat loaded and executed the selected Plugin.',
        runtimeDetailWork:
          'Verify Work execution through the generated deliverables from a real task.',
        version: 'Version',
        skillCount: 'Skills',
        exampleTasks: 'Example tasks',
        tryInCodex: 'Try it in Codex',
        tryInCodexHint:
          'Start a new Codex task and describe the business outcome you want.',
        usageFallback:
          'Use {{name}} to help me complete a task, and explain the result.',
        technicalDetails: 'Plugin technical details',
        ...
        repair: 'Repair',
        repairSuccess: '{{name}} was repaired and is ready to use.',
        repairAttention: '{{name}} was repaired but still needs attention.',
        nativeRegistration: 'Native registration',
        nativeDiscovery: 'Native discovery',
        nativeInvocation: 'Native invocation',
        available: 'Available',
        unavailable: 'Unavailable',
        uninstall: 'Uninstall',
        uninstallTitle: 'Uninstall Codex Plugin',
        uninstallConfirm: 'Uninstall {{name}} from Codex?',
        uninstallHint:
          'PilotHub will remove the complete Plugin and its managed marketplace entry.',
        uninstalling: 'Uninstalling…',
        uninstallSuccess: '{{name}} was uninstalled.',
        validation: {
          invalid_name: 'Plugin name must use lower-case kebab-case.',
          folder_name_mismatch:
            'The Plugin folder name must match the manifest name.',
          invalid_version: 'Plugin version must use semantic versioning.',
          missing_description: 'Plugin description is required.',
          unsupported_components:
            'This release only supports Skill-only Plugins.',
          invalid_skills_path: 'The configured Skills directory does not exist.',
          missing_skills: 'The Plugin must include at least one valid Skill.',
          missing_author: 'Author metadata is recommended.',
          missing_license: 'License metadata is recommended.',
          prompt_limit: 'Codex uses only the first three default prompts.',
          invalid_skill: 'One or more SKILL.md files are invalid.',
          duplicate_skill: 'Skill names must be unique inside a Plugin.',
        },
        errors: {
          invalid: 'The Plugin did not pass validation.',
      ...
      settingsSectionPrivacyDesc: 'Control local product feedback data.',
      productFeedback: {
        title: 'Local anonymous feedback',
        description:
          'Record a small set of installation outcome events on this device.',
        boundaryTitle: 'What is recorded',
        boundaryBody:
          'Installation outcome, Agent type, source type, and a standardized failure category.',
        localOnly: 'Stored only on this device. PilotHub does not upload it.',
        localEvents: '{{count}} local events',
        clearDescription: 'Remove all locally recorded feedback events.',
        clear: 'Clear data',
        enabledToast: 'Local feedback enabled',
        disabledToast: 'Local feedback disabled',
        saveFailed: 'Could not update feedback preference',
        clearedToast: 'Local feedback data cleared',
        clearFailed: 'Could not clear local feedback data',
      },
      packageManagers: {
      ...
      gitPickTitle: 'Preview Skill Collection',
      gitPickBody:
  ...
  zh: {
    translation: {
      ...
      quickInstall: {
        action: '快速安装',
        autoTargetsTitle: '自动配置 Agent',
        autoTargetsDescription: 'PilotHub 将全局安装并同步到 {{targets}}。',
        noAgentsTitle: '未检测到支持的 AI Agent',
        noAgentsDescription: '请先安装或配置一个 Agent，再添加你的第一个能力。',
        manageAgents: '管理 Agent',
        successTitle: '安装成功',
        successDescription: '{{name}} 已经可以使用。',
        installedTo: '已安装到',
        nextStep: '下一步',
        usageHint: '打开已安装的 Agent，描述你的需求，它现在可以使用 {{name}}。',
        done: '完成',
        viewSkill: '查看使用方法',
      },
      installDiagnostics: {
        action: '安装诊断',
        title: '安装诊断',
        subtitle: '检查连接、Agent 目标、目录权限和 Skill 格式。',
        running: '正在检查安装条件…',
        runningHint: '仓库校验可能需要一点时间。',
        unavailable: '无法完成诊断',
        retry: '重新检查',
        checks: {
          github: {
            title: 'GitHub 连接',
            pass: 'GitHub 连接正常。',
            warning: '暂时无法确认 GitHub 连接。',
            fail: 'PilotHub 无法连接 GitHub。{{detail}}',
            hint: '请检查网络，以及设置中的 GitHub 代理。',
          },
          agents: {
            title: 'AI Agent',
            pass: '已检测：{{detail}}',
            warning: '无法确认所选 Agent。',
            fail: '未检测到支持的 AI Agent。',
            hint: '请安装 Agent，或在“工具”中启用它。',
          },
          directories: {
            title: 'Agent 目录',
            pass: '{{count}} 个目标目录可写。',
            warning: '检测到 Agent 后才能检查目录。',
            fail: '一个或多个目标目录不可写。',
            hint: '请检查目录权限，或选择其他 Agent 目标。',
          },
          skill_format: {
            title: 'Skill 格式',
            pass: '已找到有效的 Skill 定义。',
            warning: '暂时无法确认 Skill 格式。',
            fail: '未读取到有效的 SKILL.md。{{detail}}',
            hint: '请选择包含有效 SKILL.md 的 Skill 目录或仓库。',
          },
        },
      },
      storageMigration: {
      ...
      subtitle: '管理 Antigravity、Codex 等 AI Agent 扩展能力',
      workspace: '扩展',
      ...
      extensions: {
        ...
        attention: '需要处理',
        targets: 'Agent 目标',
        noTargets: '尚未同步到 Agent',
        globalTargets: '{{count}} 个全局目标',
        projectTargets: '{{count}} 个项目目标',
        projectScope: '项目',
      ...
      plugins: {
        add: '安装 AI 能力',
        sectionTitle: 'AI 专家团与能力',
        sectionSubtitle: '面向业务目标封装，并以完整单元安装到 Codex 的能力。',
        pluginCount: '已安装 {{count}} 个',
        installTitle: '安装 AI 能力',
        expertTeam: 'AI 专家团',
        aiCapability: 'AI 能力',
        expertTeamDetails: 'AI 专家团',
        capabilityDetails: 'AI 能力',
        professionalCapabilities: '专业能力',
        professionalCapabilitiesHint:
          'Codex 会在适合任务时组合使用这些 Skills。',
        capabilityHint: 'Codex 可在匹配任务中使用的 Skill。',
        specialistCount: '{{count}} 个专业能力',
        capabilityCount: '{{count}} 个能力',
        specialists: '专业能力',
        capabilities: '能力',
        ...
        localSource: '本地目录',
        repositoryUrl: '仓库地址',
        pluginFolder: 'Plugin 目录',
        gitPlaceholder: 'https://github.com/owner/plugin',
        localPlaceholder: '~/plugins/example-plugin',
        sourceHint:
          'Plugin 必须包含 .codex-plugin/plugin.json 和至少一个有效 Skill。',
        selectFolder: '选择 Plugin 目录',
        preview: '预览',
        checking: '正在检查…',
        install: '安装到 Codex',
        installing: '正在安装…',
        ...
        runtime: '运行环境',
        runtimeStatus: '运行状态',
        runtimeStatusHint: '安装、发现和真实任务执行分别判断，避免误报。',
        runtimeCodex: 'Codex',
        runtimeChat: '聊天',
        runtimeWork: '工作',
        runtimeCount: '{{count}} 个宿主',
        runtimeVerified: '执行已验证',
        runtimeReady: '已就绪，待执行测试',
        runtimeUnverified: '尚未验证',
        runtimeDetailCodexReady: 'Codex 已报告安装并启用；需要真实任务验证执行。',
        runtimeDetailCodexUnavailable: 'Plugin 尚未在 Codex 中安装并启用。',
        runtimeDetailChat: 'PilotHub 无法读取当前聊天是否加载并执行了所选 Plugin。',
        runtimeDetailWork: '需要通过真实工作任务生成的交付文件验证执行。',
        version: '版本',
        skillCount: 'Skills',
        exampleTasks: '示例任务',
        tryInCodex: '在 Codex 中使用',
        tryInCodexHint: '新建 Codex 任务，直接描述你希望完成的业务目标。',
        usageFallback: '使用“{{name}}”帮助我完成一项任务，并说明处理结果。',
        technicalDetails: 'Plugin 技术信息',
        ...
        repair: '修复',
        repairSuccess: '{{name}} 已修复，可以正常使用。',
        repairAttention: '{{name}} 已执行修复，但仍需处理。',
        nativeRegistration: '原生注册',
        nativeDiscovery: '原生发现',
        nativeInvocation: '原生调用',
        available: '可用',
        unavailable: '不可用',
        uninstall: '卸载',
        uninstallTitle: '卸载 Codex Plugin',
        uninstallConfirm: '确定从 Codex 卸载 {{name}}？',
        uninstallHint: 'PilotHub 将删除完整 Plugin 及其托管的 marketplace 条目。',
        uninstalling: '正在卸载…',
        uninstallSuccess: '{{name}} 已卸载。',
        validation: {
          invalid_name: 'Plugin 名称必须使用小写 kebab-case。',
          folder_name_mismatch: 'Plugin 目录名必须与清单中的名称一致。',
          invalid_version: 'Plugin 版本必须使用语义化版本。',
          missing_description: 'Plugin 必须提供描述。',
          unsupported_components: '当前版本仅支持 Skill-only Plugin。',
          invalid_skills_path: '配置的 Skills 目录不存在。',
          missing_skills: 'Plugin 必须至少包含一个有效 Skill。',
          missing_author: '建议补充作者信息。',
          missing_license: '建议补充许可证信息。',
          prompt_limit: 'Codex 仅使用前三条默认提示词。',
          invalid_skill: '一个或多个 SKILL.md 格式无效。',
          duplicate_skill: '同一个 Plugin 内的 Skill 名称不能重复。',
        },
        errors: {
          invalid: 'Plugin 未通过结构校验。',
      ...
      settingsSectionPrivacyDesc: '管理保存在本机的产品反馈数据。',
      productFeedback: {
        title: '本地匿名反馈',
        description: '在本机记录少量安装结果事件，帮助了解安装体验。',
        boundaryTitle: '记录范围',
        boundaryBody: '仅记录安装结果、Agent 类型、来源类型和标准化失败类别。',
        localOnly: '数据只保存在此设备，PilotHub 不会上传。',
        localEvents: '本地已有 {{count}} 条记录',
        clearDescription: '删除本机保存的全部匿名反馈记录。',
        clear: '清除数据',
        enabledToast: '已开启本地匿名反馈',
        disabledToast: '已关闭本地匿名反馈',
        saveFailed: '无法更新匿名反馈设置',
        clearedToast: '已清除本地匿名反馈数据',
        clearFailed: '无法清除本地匿名反馈数据',
      },
      packageManagers: {
        detecting: '正在检测包管理器...',
        none: '暂无包管理器状态。',
      ...
      gitPickTitle: '预览 Skill Collection',
